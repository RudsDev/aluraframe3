...
System.register(["../models/ListaNegociacoes", "../models/Mensagem", "../models/Negociacao", "../views/NegociacoesView", "../views/MensagemView", "../services/NegociacaoService", "../helpers/DateHelper", "../services/Bind"], function (_export, _context) {
    "use strict";
    ...
    return {
        ...
        }, function (_servicesBind) {
            Bind = _servicesBind.Bind;
        }],
        execute: function () {
